...
export const sessionData = {
    1: {
        ...
        analysis: {
            ...
            satisfaction: "Moyenne. Physiquement, c'est accessible, mais je me sens 'gauche' et raide par rapport à la fluidité demandée.",
    ...
    2: {
        ...
        feelings: {
            physique: "Beaucoup de micro-mouvements dans la cheville d'appui pour ne pas tomber (recherche d'équilibre). J'ai senti la difficulté de garder le bassin de face tout en ouvrant le genou sur le côté. La consigne de 'sangler' la partie externe du genou m'a aidé à stabiliser la jambe de terre.",
            respiration: "Dès que je perdais l'équilibre, je bloquais ma respiration. J'ai dû faire un effort conscient pour garder une respiration fluide malgré l'instabilité, car j'avais tendance à l'apnée par concentration.",
            mental: "J'ai remarqué que si mon regard quittait le point fixe à l'horizon, je tombais immédiatement. La concentration devait être totale ; impossible de penser à autre chose."
        },
        analysis: {
            quoi: "L'importance de l'ancrage au sol (imaginer des racines) avant même de lever la jambe. J'ai découvert le concept de proprioception : ma capacité à ressentir finement mon corps pour m'adapter à l'instabilité.",
    ...
    3: {
        ...
        feelings: {
            ...
            respiration: "J'ai appris à synchroniser : 'Inspirer pour tout mouvement qui ouvre l'avant du corps'. C'était difficile de respirer amplement avec le ventre comprimé contre le sol.",
    ...
    4: {
        ...
        learned: {
            text: "Exercice de relaxation et d'étirement passif pratiqué à deux. Je suis allongé sur le dos, bras tendus au-dessus de la tête. Mon partenaire, assis derrière moi (en posture du diamant ou genoux relevés), saisit mes poignets. Il exerce une traction douce, progressive et régulière vers l'arrière pour étirer mes épaules et omoplates, tout en pressant un point énergétique spécifique sur mes poignets."
        },
        feelings: {
            physique: "Au début, j'avais le réflexe de contracter mes épaules et même mes fessiers pour 'aider' ou par protection. J'ai dû faire un effort conscient pour détendre mes cuisses et fessiers comme demandé. La pression sur l'os pisiforme (poignet) m'a procuré une sensation de détente immédiate.",
            respiration: "J'ai calé ma respiration sur l'étirement (minimum 6 cycles inspir-expir). J'ai senti que l'expiration longue activait mon système parasympathique (le frein du corps), me permettant de relâcher les tensions musculaires accumulées.",
        ...
        analysis: {
            ...
            satisfaction: "Très élevée. C'est rare de sentir un étirement aussi profond sans avoir à fournir d'effort musculaire soi-même. Sensation de légèreté dans le haut du dos après la séance.",
    ...
    5: {
        ...
        feelings: {
            physique: "J'ai senti une forte sollicitation de l'épaule et du poignet d'appui, plus intense que dans mes gainages habituels sur les coudes. J'ai ressenti le tremblement lié à la recherche d'équilibre (proprioception). Mes obliques brûlaient pour maintenir le bassin haut.",
            ...
            mental: "J'ai observé une montée de frustration (émotion négative) quand je perdais l'équilibre. J'ai failli tomber dans le 'tout ou rien' (distorsion cognitive : 'si je bouge, c'est raté'). J'ai essayé d'accepter ce déséquilibre pour me stabiliser calmement au lieu de m'énerver."
        },
        analysis: {
    ...
    6: {
        ...
        feelings: {
            ...
            respiration: "La respiration abdominale était limitée par l'extension, j'ai donc dû placer mon souffle dans le haut du thorax. J'ai senti que cela 'massait' mes organes internes.",
            mental: "Une sensation d'apaisement rapide. Bien que l'effort musculaire soit présent dans les jambes, le haut du corps était en détente relative. J'ai senti que cela calmait mon agitation mentale."
        },
        analysis: {
            ...
            satisfaction: "Très satisfaisante. C'est un pont entre le renforcement musculaire (que j'aime) et la relaxation.",
            ...
            utility: "Excellent pour compenser les positions assises (cours théoriques) ou les sports qui 'ferment' les épaules (boxe, vélo). Utile aussi comme récupération active après une compétition pour réguler le taux de cortisol."
        }
    },
    // Exemple vide pour le jour 2 (à dupliquer pour les autres)
    7: {
        ...
        feelings: {
            physique: "Une sensation très étrange 'd'aspiration' à l'intérieur du ventre, comme si mes organes remontaient sous mes côtes.J'ai senti une forte chaleur monter rapidement. C'est très différent du gainage classique: ici, on ne contracte pas les abdos vers l'extérieur, on les plaque contre la colonne.",
        ...
        analysis: {
            quoi: "Que le ventre est notre '2ème cerveau' et le siège de nos émotions. Cet exercice masse les organes internes et stimule la digestion et l'immunité. J'ai appris la technique du 'Jalandhara bandha' (menton vers le sternum) pour verrouiller l'énergie.",
            satisfaction: "Très élevée. C'est un mouvement impressionnant visuellement et techniquement exigeant.",
            progression: "Tenir la rétention (poumons vides) plus longtemps sans crispation, et réussir à le faire le dos plus droit.",
            utility: "C'est l'exercice roi pour renforcer le muscle transverse (ventre plat). Indispensable pour protéger mes lombaires lors des squats lourds ou soulevés de terre en musculation, et pour améliorer ma digestion."
        }
    },
    // Exemple vide pour le jour 2 (à dupliquer pour les autres)
    8: {
        ...
        feelings: {
            physique: "J'ai senti la différence immédiate grâce à la sangle : je pouvais détendre mon haut du corps (épaules/nuque) au lieu de forcer pour attraper ma jambe. L'étirement dans les ischio-jambiers et le mollet était intense mais contrôlé. Lors de l'ouverture sur le côté, c'était un vrai défi de ne pas décoller la fesse opposée (crête iliaque) du sol.",
            respiration: "Respiration fluide et apaisée. Le fait d'être allongé aide à bien respirer avec le ventre. J'ai utilisé l'expiration pour 'lâcher' un peu plus de lest dans la sangle et gagner quelques millimètres d'amplitude.",
        ...
        analysis: {
            quoi: "J'ai compris l'utilité des accessoires (sangle) : ce n'est pas une 'béquille' mais un outil pour garder un alignement correct (dos plat, sacrum au sol). J'ai appris que cet exercice favorise le retour veineux et la récupération musculaire après une séance de sport (jambes lourdes).",
    ...
    10: {
        ...
        analysis: {
            quoi: "Que cet exercice ne travaille pas seulement les jambes, mais tonifie aussi les organes abdominaux (digestion) et le cœur. Il permet de 'réduire la graisse sur la taille' (selon le document), ce qui complète bien mon entraînement physique. J'ai appris à créer une ligne d'énergie ininterrompue.",
    ...
    11: {
        ...
        analysis: {
            quoi: "La dissociation des ceintures (pelvienne et scapulaire). J'ai appris qu'on peut être stable et mobile en même temps. C'est une introduction au 'Vinyasa' (mouvement synchronisé au souffle).",
            satisfaction: "Très plaisant. Je me sens moins 'raide' et plus gracieux que dans les postures statiques pures.",
